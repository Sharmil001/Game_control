...
import imutils
import time
from directcontol import W, A, S, D
from directcontol import PressKey, ReleaseKey

# define the lower and upper boundaries of the "Blue" object in the HSV color space  (use any color)
